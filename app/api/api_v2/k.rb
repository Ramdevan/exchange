module APIv2
  class K < Grape::API
    ...
    params do
      ...
      optional :endtimestamp, type: Integer, desc: "An integer represents the seconds elapsed since Unix epoch. If set, only k-line data after that time will be returned."
    end
    get "/k" do
      get_k_json
    end
    ...
    desc "Get Current time Timestamp for Tradingview Chart"
    get "/time" do
