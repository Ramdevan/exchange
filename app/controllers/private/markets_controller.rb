module Private
  class MarketsController < BaseController
    ...
    def visible_market?
      redirect_to market_path(Market.default_one) if not current_market.visible?
    end
    ...
    def set_member_data
      @member = current_user
      @orders_wait = @member.orders.with_currency(@market).with_state(:wait).limit(100)
      # ITS NOT BEEN DISPLAYED IN MARKET PAGE. SO COMMENT IT OUT
