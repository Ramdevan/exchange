...
describe APIv2::Trades do
  ...
  describe 'GET /api/v2/trades/:market/my' do
    it "should require authentication" do
      get '/api/v2/trades/btccny/my', access_key: 'test', tonce: time_to_milliseconds, signature: 'test'
    ...
    it "should return all my recent trades" do
      signed_get '/api/v2/trades/btccny/my', params: {}, token: token
      response.should be_success
    ...
    it "should return 1 trade" do
      signed_get '/api/v2/trades/btccny/my', params: {limit: 1}, token: token
      response.should be_success
      JSON.parse(response.body).should have(1).trade
    end

    it "should return trades before timestamp" do
      signed_get '/api/v2/trades/btccny/my', params: {timestamp: 30.hours.ago.to_i}, token: token
      response.should be_success
      JSON.parse(response.body).should have(1).trade
    end

    it "should return limit out of range error" do
      signed_get '/api/v2/trades/btccny/my', params: {limit: 1024}, token: token
